...
export const startersApi = {
  ...
  addFeeding: (
    starterId: number,
    data: { flour_grams?: number; water_grams?: number; starter_grams?: number; height_mm?: number; ambient_temp_f?: number; flour_type?: string; flour_brand?: string; notes?: string },
  ) =>
